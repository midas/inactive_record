...
Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "Manifest.txt", "PostInstall.txt", "README.rdoc", "Rakefile", "lib/inactive_record.rb", "lib/inactive_record/base.rb", "script/console", "script/destroy", "script/generate", "spec/inactive_record/base_spec.rb", "spec/inactive_record_spec.rb", "spec/spec.opts", "spec/spec_helper.rb", "tasks/rspec.rake"]
  s.has_rdoc = true
